...
{
  float tLeft = float(rcTime(4));            // Get left light & make float
  float tRight = float(rcTime(2));           // Get right light & make float
  float tBack = float(rcTime(5));
  float tMid = float(rcTime(3));
...
//            -Insert Fire-Breathing Chicken Here-
...
//                   -Insert Hanzo Here-
  ...
  { // Slow down left wheel
    ...
    //speedLeft = 10;
    //speedRight = 300;                        // Full speed right wheel
  }
  else                                       // Shade on Left?
  { // Slow down right wheel
    ...
    //speedRight = 10;
    //speedLeft = 300;                         // Full speed left wheel
  }
